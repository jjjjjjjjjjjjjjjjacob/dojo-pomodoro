...
mock.module('@clerk/nextjs', () => ({
  ...
  SignOutButton: () => React.createElement('button', { 'data-testid': 'sign-out-button' }, 'Sign Out'),
  OrganizationSwitcher: () => React.createElement('div', { 'data-testid': 'org-switcher' }, 'Org Switcher'),
